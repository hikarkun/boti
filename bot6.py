...
class PiggyGameBot:
    ...
    def load_accounts(self) -> List[Dict[str, str]]:
        """加载账户信息"""
        json_accounts_path = "config/accounts6.json"
        ...
        try:
            ...
            print("错误: 账户配置文件不存在，请创建config/accounts6.json文件")
            return []
    ...
    def get_random_user_agent(self) -> str:
        ...
        try:
            ...
            user_agents = [
                'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/143.0.7499.88 Safari/537.36',
                'Mozilla/5.0 (Macintosh; Intel Mac OS X 13_6_2) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/143.0.7499.71 Safari/537.36',
                'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.7444.240 Safari/537.36',
                'Mozilla/5.0 (Windows NT 11.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.7444.181 Safari/537.36',
                'Mozilla/5.0 (Macintosh; Intel Mac OS X 14_1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/143.0.7499.102 Safari/537.36',
                'Mozilla/5.0 (X11; Ubuntu; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/143.0.7499.66 Safari/537.36',
                'Mozilla/5.0 (Android 14; Pixel 8 Pro) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/143.0.7499.90 Mobile Safari/537.36',
                'Mozilla/5.0 (Android 13; SM-S918B) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.7444.210 Mobile Safari/537.36',
                'Mozilla/5.0 (iPhone; CPU iPhone OS 17_3 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) CriOS/143.0.7499.115 Mobile/15E148 Safari/604.1',
                'Mozilla/5.0 (iPad; CPU OS 17_2 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) CriOS/142.0.7444.255 Mobile/15E148 Safari/604.1'
            ]
