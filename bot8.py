...
class PiggyGameBot:
    ...
    def load_accounts(self) -> List[Dict[str, str]]:
        """加载账户信息"""
        json_accounts_path = "config/accounts8.json"
        ...
        try:
            ...
            print("错误: 账户配置文件不存在，请创建config/accounts8.json文件")
            return []
    ...
    def get_random_user_agent(self) -> str:
        ...
        try:
            ...
            user_agents = [
                ...
                'Mozilla/5.0 (Macintosh; Apple Silicon; Mac OS X 13_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/141.0.0.0 Safari/537.36',
                'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/139.0.0.0 Safari/537.36',
                'Mozilla/5.0 (X11; Fedora; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.1.0 Safari/537.36',
                'Mozilla/5.0 (Android 11; SM-G991B) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/141.0.0.0 Mobile Safari/537.36',
                'Mozilla/5.0 (Android 14; Pixel 8) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Mobile Safari/537.36',
                'Mozilla/5.0 (iPhone; CPU iPhone OS 17_2 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) CriOS/142.0.0.0 Mobile/15E148 Safari/604.1',
                'Mozilla/5.0 (iPad; CPU OS 17_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) CriOS/141.0.0.0 Mobile/15E148 Safari/604.1',
            ]
